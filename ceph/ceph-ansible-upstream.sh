...
yum install -y  wget vim screen git python telnet ansible
cd /root && git clone https://github.com/ceph/ceph-ansible/
...
echo "deprecation_warnings = False" >> /root/ceph-ansible/ansible.cfg
